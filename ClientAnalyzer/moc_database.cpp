...
QT_MOC_LITERAL(9, 62, 14), // "slotCloseOldDB"
QT_MOC_LITERAL(10, 77, 13) // "slotOpenNewDB"

    },
    "DataBase\0inserIntoTable\0\0data\0fname\0"
    "sname\0nik\0removeRecord\0id\0slotCloseOldDB\0"
    "slotOpenNewDB"
};
...
void DataBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: { bool _r = _t->removeRecord((*reinterpret_cast< const int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 3: _t->slotCloseOldDB(); break;
        case 4: _t->slotOpenNewDB(); break;
        default: ;
        }
    }
}
